...
const translations = {
  en: {
    ...
    // ── Purchase flow ──
    buy_qty_invalid: '❌ Enter a valid number (minimum 1).',
    buy_qty_max: '❌ Only <b>{qty}</b> available.',
    buy_enter_email: '📧 <b>Enter your email address:</b>',
    buy_email_invalid: '❌ Invalid email. Example: <code>user@gmail.com</code>',
    buy_session_expired: '❌ Session expired. Please start again.',
    buy_session_expired_order: '❌ Session expired. Please start the order again.',
    buy_browse_products: '🛍 Browse Products',
    buy_stock_changed: '❌ Stock changed. Please start again.',
    buy_order_cancelled: '❌ <b>Order cancelled.</b>',
    buy_processing: '⏳ Processing... please wait',
    buy_order_not_found: '❌ Order not found or already processed.',
    buy_already_processed: '❌ This order has already been processed.',
    buy_payment_error: '❌ Payment processing error. Please try again.',
    buy_orderid_used: '❌ This Order ID has already been used.',
    buy_txid_invalid: '❌ Invalid TxID format.',
    buy_txid_used: '❌ This TxID has already been used.',
    buy_payid_used: '❌ This payment ID has already been used.',
    buy_usdt_only: '❌ Only USDT is accepted. Got {currency}.',
    buy_notify_restock: '🔔 Notify me when back in stock',
    buy_back_products: '🔙 Back to Products',
    buy_my_orders: '📦 My Orders',
    buy_delivery_email: '📧 <b>Delivery Email:</b>',
    buy_payment_id: '🧾 <b>Payment ID:</b>',
    buy_new_balance: '💰 <b>New Balance:</b>',
    buy_order_attachment: '📎 Order #{id} — {n} item(s)',
},
  ...
  ar: {
    ...
    // ── Purchase flow ──
    buy_qty_invalid: '❌ أدخل رقماً صحيحاً (1 على الأقل).',
    buy_qty_max: '❌ المتوفّر <b>{qty}</b> فقط.',
    buy_enter_email: '📧 <b>أدخل بريدك الإلكتروني:</b>',
    buy_email_invalid: '❌ بريد غير صالح. مثال: <code>user@gmail.com</code>',
    buy_session_expired: '❌ انتهت الجلسة. ابدأ من جديد.',
    buy_session_expired_order: '❌ انتهت الجلسة. أعد بدء الطلب.',
    buy_browse_products: '🛍 تصفّح المنتجات',
    buy_stock_changed: '❌ تغيّر المخزون. ابدأ من جديد.',
    buy_order_cancelled: '❌ <b>أُلغي الطلب.</b>',
    buy_processing: '⏳ جارٍ المعالجة… انتظر قليلاً',
    buy_order_not_found: '❌ الطلب غير موجود أو تمّت معالجته.',
    buy_already_processed: '❌ هذا الطلب تمّت معالجته سابقاً.',
    buy_payment_error: '❌ خطأ في معالجة الدفع. حاول مجدداً.',
    buy_orderid_used: '❌ رقم الطلب هذا مستعمَل سابقاً.',
    buy_txid_invalid: '❌ صيغة TxID غير صحيحة.',
    buy_txid_used: '❌ هذا الـTxID مستعمَل سابقاً.',
    buy_payid_used: '❌ معرّف الدفع هذا مستعمَل سابقاً.',
    buy_usdt_only: '❌ لا نقبل إلا USDT. وصلنا {currency}.',
    buy_notify_restock: '🔔 نبّهني عند توفّره',
    buy_back_products: '🔙 رجوع للمنتجات',
    buy_my_orders: '📦 طلباتي',
    buy_delivery_email: '📧 <b>بريد التسليم:</b>',
    buy_payment_id: '🧾 <b>معرّف الدفع:</b>',
    buy_new_balance: '💰 <b>الرصيد الجديد:</b>',
    buy_order_attachment: '📎 الطلب #{id} — {n} عنصر',
},
  ...
  vi: {
    ...
    // ── Purchase flow ──
    buy_qty_invalid: '❌ Nhập số hợp lệ (tối thiểu 1).',
    buy_qty_max: '❌ Chỉ còn <b>{qty}</b>.',
    buy_enter_email: '📧 <b>Nhập địa chỉ email của bạn:</b>',
    buy_email_invalid: '❌ Email không hợp lệ. Ví dụ: <code>user@gmail.com</code>',
    buy_session_expired: '❌ Phiên đã hết hạn. Vui lòng bắt đầu lại.',
    buy_session_expired_order: '❌ Phiên đã hết hạn. Vui lòng đặt lại đơn.',
    buy_browse_products: '🛍 Xem sản phẩm',
    buy_stock_changed: '❌ Kho đã thay đổi. Vui lòng bắt đầu lại.',
    buy_order_cancelled: '❌ <b>Đơn hàng đã hủy.</b>',
    buy_processing: '⏳ Đang xử lý... vui lòng đợi',
    buy_order_not_found: '❌ Không tìm thấy đơn hoặc đã xử lý.',
    buy_already_processed: '❌ Đơn này đã được xử lý.',
    buy_payment_error: '❌ Lỗi xử lý thanh toán. Vui lòng thử lại.',
    buy_orderid_used: '❌ Mã đơn này đã được dùng.',
    buy_txid_invalid: '❌ Định dạng TxID không hợp lệ.',
    buy_txid_used: '❌ TxID này đã được dùng.',
    buy_payid_used: '❌ Mã thanh toán này đã được dùng.',
    buy_usdt_only: '❌ Chỉ chấp nhận USDT. Nhận được {currency}.',
    buy_notify_restock: '🔔 Báo tôi khi có hàng lại',
    buy_back_products: '🔙 Quay lại sản phẩm',
    buy_my_orders: '📦 Đơn của tôi',
    buy_delivery_email: '📧 <b>Email nhận hàng:</b>',
    buy_payment_id: '🧾 <b>Mã thanh toán:</b>',
    buy_new_balance: '💰 <b>Số dư mới:</b>',
    buy_order_attachment: '📎 Đơn #{id} — {n} mục',
},
  ...
  es: {
    ...
    // ── Purchase flow ──
    buy_qty_invalid: '❌ Introduce un número válido (mínimo 1).',
    buy_qty_max: '❌ Solo hay <b>{qty}</b> disponibles.',
    buy_enter_email: '📧 <b>Introduce tu correo electrónico:</b>',
    buy_email_invalid: '❌ Correo no válido. Ejemplo: <code>user@gmail.com</code>',
    buy_session_expired: '❌ La sesión ha caducado. Empieza de nuevo.',
    buy_session_expired_order: '❌ La sesión ha caducado. Vuelve a iniciar el pedido.',
    buy_browse_products: '🛍 Ver productos',
    buy_stock_changed: '❌ El stock ha cambiado. Empieza de nuevo.',
    buy_order_cancelled: '❌ <b>Pedido cancelado.</b>',
    buy_processing: '⏳ Procesando... espera un momento',
    buy_order_not_found: '❌ Pedido no encontrado o ya procesado.',
    buy_already_processed: '❌ Este pedido ya fue procesado.',
    buy_payment_error: '❌ Error al procesar el pago. Inténtalo de nuevo.',
    buy_orderid_used: '❌ Este ID de pedido ya se ha usado.',
    buy_txid_invalid: '❌ Formato de TxID no válido.',
    buy_txid_used: '❌ Este TxID ya se ha usado.',
    buy_payid_used: '❌ Este ID de pago ya se ha usado.',
    buy_usdt_only: '❌ Solo se acepta USDT. Se recibió {currency}.',
    buy_notify_restock: '🔔 Avísame cuando vuelva',
    buy_back_products: '🔙 Volver a productos',
    buy_my_orders: '📦 Mis pedidos',
    buy_delivery_email: '📧 <b>Correo de entrega:</b>',
    buy_payment_id: '🧾 <b>ID de pago:</b>',
    buy_new_balance: '💰 <b>Nuevo saldo:</b>',
    buy_order_attachment: '📎 Pedido #{id} — {n} artículo(s)',
},
};
