...
const translations = {
  en: {
    ...
    nav_hint: '⌨️ <i>The bar below stays put — tap any section at any time.</i>',
    btn_api: '🔌 API Access',
  ...
  ar: {
    ...
    btn_vip: '🏆 رتبتي',
    btn_refunds: '🔄 طلب استرداد',
    nav_hint: '⌨️ <i>الشريط بالأسفل ثابت — اضغط أي قسم في أي وقت.</i>',
    btn_api: '🔌 واجهة API',
  ...
  vi: {
    ...
    btn_vip: '🏆 Hạng của tôi',
    btn_refunds: '🔄 Yêu cầu hoàn tiền',
    nav_hint: '⌨️ <i>Thanh bên dưới luôn hiển thị — chạm vào mục bất kỳ lúc nào.</i>',
    btn_api: '🔌 Truy cập API',
  ...
  es: {
    ...
    btn_vip: '🏆 Mi rango',
    btn_refunds: '🔄 Solicitar reembolso',
    nav_hint: '⌨️ <i>La barra de abajo permanece fija: toca cualquier sección cuando quieras.</i>',
    btn_api: '🔌 Acceso API',
